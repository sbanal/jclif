...
public abstract class CommandLineParser {
   ...
   * @throws InvalidInputException thrown if options passed does not match with the option metadata
   *         configuration
   */
  public abstract CommandLineParseResult parse(CommandLineConfiguration configuration,
   ...
   */
  public abstract boolean matches(CommandLineConfiguration configuration,
      CommandLineParseResult resultSet, String... args);
