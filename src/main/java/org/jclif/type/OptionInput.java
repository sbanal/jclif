...
/**
 * Option class represents the option parsed from a command line input. An Option class may or may
 * not have a corresponding parameter depending on if an options accepts a parameter or not.
 * 
