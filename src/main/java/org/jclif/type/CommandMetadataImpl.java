...
public class CommandMetadataImpl extends InputMetadataImpl implements CommandMetadata {
  ...
  public CommandMetadataImpl(String keyword, OptionConfiguration optionConfiguration,
      ParameterConfiguration parameterConfiguration, String description, String longDescription) {
    this(keyword, optionConfiguration,
        (parameterConfiguration != null) ? new ArrayList<ParameterMetadata>(
            parameterConfiguration.values()) : null, description, longDescription);
  }

  public CommandMetadataImpl(String keyword, OptionConfiguration optionConfiguration,
      List<ParameterMetadata> parameters, String description, String longDescription) {
  ...
  public CommandMetadataImpl(String keyword, String description, String longDescription) {
    this(keyword, new OptionConfiguration(), (ParameterConfiguration) null, description,
        longDescription);
  }
