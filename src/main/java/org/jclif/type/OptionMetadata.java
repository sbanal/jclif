...
/**
 * OptionMetadata interface defines the common properties that describes a command line option.
 * 
...
public interface OptionMetadata extends InputMetadata {
  ...
  /**
   * Returns the option key passed in command line depending on identifier format. Returned value
   * can be either the long identifier value or the short identifier. For example, -f=file.txt
   * versus --file=file.txt.
   * 
