...
/**
 * This class serves as container of command line related properties used for parsing like option
 * prefix and option-parameter character delimiter.
 * 
...
public class CommandLineProperties implements Cloneable {
  ...
  /**
   * Default delimiter between a command line option and its parameter in used in *nix based
   * systems.
   */
  public static final String DEFAULT_UNIX_OPTION_PARAMETER_DELIM = " ";

  /**
   * Default delimiter between a command line option and its parameter in used in windows based
   * systems.
   */
  ...
  private final static CommandLineProperties WINDOWS_COMMAND_LINE_PROPERTIES =
      new CommandLineProperties(DEFAULT_WIN_OPTION_PREFIX, DEFAULT_WIN_OPTION_LONG_PREFIX,
          DEFAULT_UNIX_OPTION_PARAMETER_DELIM);
  private final static CommandLineProperties UNIX_COMMAND_LINE_PROPERTIES =
      new CommandLineProperties(DEFAULT_UNIX_OPTION_PREFIX, DEFAULT_UNIX_OPTION_LONG_PREFIX,
          DEFAULT_UNIX_OPTION_PARAMETER_DELIM);
   ...
   */
  public CommandLineProperties(String optionPrefix, String optionLongPrefix,
  ...
  public Object clone() {
    try {
      super.clone();
      return new CommandLineProperties(this.getOptionPrefix(), this.getOptionLongPrefix(),
          this.getOptionParameterDelim());
    } catch (CloneNotSupportedException e) {
      Logger.getLogger(CommandLineProperties.class.getCanonicalName()).log(Level.SEVERE,
          "Clone failed in class " + this.getClass(), e);
      return null;
    }
  }
