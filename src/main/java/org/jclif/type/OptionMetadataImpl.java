...
public class OptionMetadataImpl extends InputMetadataImpl implements OptionMetadata {
  ...
  public OptionMetadataImpl(Option optionAnnotation, ParameterMetadata parameterMetadata,
      boolean multiValued) {
    this(optionAnnotation.identifier(), optionAnnotation.longIdentifier(), parameterMetadata,
        optionAnnotation.required(), multiValued, optionAnnotation.description(), optionAnnotation
            .longDescription());
  }
  ...
  public OptionMetadataImpl(String identifier, String longIdentifier,
      ParameterMetadata parameterMetadata, boolean required, boolean multiValued,
  ...
  public String toString() {
    return String
        .format(
            "OptionMetadataImpl[id=%s,lid=%s,desc=%s,ldesc=%s,required=%b,multi-valued=%b,parameter-accepted=%b,parameter=%s]",
            getIdentifier(), getIdentifier(IdentifierType.LONG), this.getDescription(),
            this.getLongDescription(), this.isRequired(), this.isMultiValued(),
            isParameterAccepted(), (getParameterMetadata() == null) ? "" : getParameterMetadata());
  }
