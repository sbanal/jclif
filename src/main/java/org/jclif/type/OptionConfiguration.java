...
/**
 * OptionConfiguration class serves as container of all metadata information of an applications
...
public class OptionConfiguration extends Configuration<OptionMetadata> {
  ...
  public OptionConfiguration addOption(OptionMetadata option) {
    ...
    if (longIdentfier != null && !longIdentfier.isEmpty()
   ...
   * @param identifier identifier
   * @param required true if option is required, otherwise false
   * @param multiValued true if option is multi-valued, option is multi-valued if it can be
   *        specified more than once in comman line
   * @param description description of option
   * @return OptionConfiguration this configuration
   */
  ...
  public OptionConfiguration addOption(String identifier, String longIdentifier,
      ParameterMetadata parameter, boolean required, boolean multiValued, String description,
      String longDescription) {

    OptionMetadata option =
        new OptionMetadataImpl(identifier, longIdentifier, parameter, required, multiValued,
   ...
   * @return OptionConfiguration this configuration
   */
  public OptionConfiguration addOption(String identifier, ParameterType parameterType,
      String description) {

    ParameterMetadata parameter = new ParameterMetadataImpl(identifier, parameterType);
    OptionMetadata option =
        new OptionMetadataImpl(identifier, "", parameter, true, false, description, "");
    addOption(option);
   ...
   */
  public OptionConfiguration addOption(String identifier, String longIdentifier,
      ParameterType parameterType, boolean required, boolean multiValued, String description,
      String longDescription) {
