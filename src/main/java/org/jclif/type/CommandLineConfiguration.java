...
/**
 * CommandLineConfiguration class is used to define the command line inputs accepted by an
 * application. This is the class from which we specify the accepted options, parameters and
...
public class CommandLineConfiguration {
  ...
  /**
   * Creates a new command line configuration using the specified operating system name. Defaults to
   * linux/unix OS if name does not start with "<i>win</i>".
   * 
  ...
  /**
   * Returns parameter configuration which contains all the parameters supported in a command line
   * input.
   * 
  ...
  /**
   * Returns command configuration which contains all the commands supported in a command line
   * input.
   * 
