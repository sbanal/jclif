...
/**
 * This class is a collection which serves as container of all input types parsed from a command
 * line input. Collection enforces that each input collected is unique based on the identifier of
 * the input.
 * 
