...
public class ParameterMetadataImpl extends InputMetadataImpl implements ParameterMetadata {
	...
	public ParameterMetadataImpl(String identifier, boolean required, boolean multiValued, String description) {
		this(identifier, required, multiValued, description, null, ParameterType.STRING, null);
	}
	
	public ParameterMetadataImpl(String identifier, boolean required, boolean multiValued, ParameterType type, String description) {
		this(identifier, required, multiValued, description, null, type, null);
	}
	
	public ParameterMetadataImpl(String identifier, boolean required, boolean multiValued, ParameterType type, 
			String description, String longDescription) {
		this(identifier, required, multiValued, description, longDescription, type, null);
	}
	
	public ParameterMetadataImpl(String identifier, boolean required, boolean multiValued, String description, String longDescription) {
		this(identifier, required, multiValued, description, longDescription, ParameterType.STRING, null);
	}
	
	public ParameterMetadataImpl(String identifier, boolean required, boolean multiValued, String description, String longDescription,
			ParameterType parameterType, ParameterParser parameterValidator) {
	...
	public String toString() {
		return String.format("ParameterMetadataImpl[id=%s,desc=%s,ldesc=%s,type=%s,required=%b,multi-valued=%b,validator=%s]", 
				getIdentifier(), 
				this.getDescription(), this.getLongDescription(), 
