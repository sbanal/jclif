...
/**
 * ParameterType enum defines the different option parameter types supported. Parameter type
 * basically represents the value provided with the option in a command line.
 * <p>
 * Example: <code>
 * java -jar myapp.jar -f "file.txt" -d ";"
 * </code>
 * <p>
 * In example above, the options are -f and -d while the parameters are "file.txt" and ";"
 * respectively. Types could be defined as ParameterType.FILE for "file.txt" while
 * ParameterType.STRING for ";".
 * 
